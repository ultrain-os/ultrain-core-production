...
bool alt_bn128_G1::is_well_formed() const
{
    ...
    else
    {
        ...
        */
        ...
        // std::cout<<"well_formed X3: "<< X3 <<std::endl;
        // std::cout<<"well_formed Y2: "<< Y2 <<std::endl;
        // std::cout<<"well_formed Z6: "<< Z6 <<std::endl;
        // std::cout<<"well_formed Z6: "<< alt_bn128_coeff_b * Z6 <<std::endl;

        // // std::cout<<"well_formed alt_bn128_Fq: "<< alt_bn128_Fq <<std::endl;
        // std::cout<<"well_formed alt_bn128_coeff_b: "<< alt_bn128_coeff_b <<std::endl;
...
std::ostream& operator<<(std::ostream &out, const alt_bn128_G1 &g)
{
    ...
    //debug
    //std::cout<<std::endl<<"x= "<<copy.X<<std::endl<<"y= "<<copy.Y << std::endl;
    //std::cout<<"G1_one: "<<alt_bn128_G1::G1_one <<std::endl;
    // std::cout<<"x^3: "<<copy.X* copy.X * copy.X <<std::endl;
    // std::cout<<"y^2: "<<copy.Y* copy.Y <<std::endl;
    // std::cout<<"well_formed: "<<copy.is_well_formed()<<std::endl;
#else
    /* storing LSB of Y */

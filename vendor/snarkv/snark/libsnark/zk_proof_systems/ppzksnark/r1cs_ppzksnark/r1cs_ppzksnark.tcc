...
r1cs_ppzksnark_keypair<ppT> r1cs_ppzksnark_generator(const r1cs_ppzksnark_constraint_system<ppT> &cs)
{
    ...
    // fp.open("keys/pk.dat"); 
    // assert(fp);
    // std::cout<<"writing pk"<<std::endl;
    // fp<<pk <<std::endl;
    // fp.close();

    // fp.open("keys/vk.dat");
    // assert(fp);
    // std::cout<<"writing vk"<<std::endl;
    // fp<<vk <<std::endl;
    // fp.close();
                                                ...
                                                const r1cs_ppzksnark_auxiliary_input<ppT> &auxiliary_input)
{
    ...
    // write proof to file
    // fp.open("keys/proof.dat");
    // assert(fp);
    // std::cout<<"writing proof"<<std::endl;
    // fp<<proof <<std::endl;
    // fp.close();
...
r1cs_ppzksnark_processed_verification_key<ppT> r1cs_ppzksnark_verifier_process_vk(const r1cs_ppzksnark_verification_key<ppT> &vk)
{
    ...
    // write proof to file
    // fp.open("keys/pvk.dat");
    // assert(fp);
    // std::cout<<"writing process vk"<<std::endl;
    // fp<<pvk <<std::endl;
    // fp.close();
                                            ...
                                            const r1cs_ppzksnark_proof<ppT> &proof)
{
    ...
    //cout<<"pvk.encoded_IC_query: "<<endl<<pvk.encoded_IC_query <<endl;
    ...
    //cout<<"accumulated_IC: "<<endl<<accumulated_IC.first <<endl << accumulated_IC.second;

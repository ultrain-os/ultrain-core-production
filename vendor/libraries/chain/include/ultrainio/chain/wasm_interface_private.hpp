...
using namespace fc;
using namespace ultrainio::chain::webassembly;
using namespace IR;
   ...
   struct wasm_interface_impl {
      ...
      std::vector<uint8_t> parse_initial_memory(const Module& module) {
         ...
         for(const DataSegment& data_segment : module.dataSegments) {
            ULTRAIN_ASSERT(data_segment.baseOffset.type == InitializerExpression::Type::i32_const, wasm_exception, "");
            ULTRAIN_ASSERT(module.memories.defs.size(), wasm_exception, "");

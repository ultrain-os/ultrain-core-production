...
abi_def ultrainio_contract_abi(const abi_def& ultrainio_system_abi);
vector<type_def> common_type_defs();

} } /// namespace ultrainio::chain

FC_REFLECT( ultrainio::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( ultrainio::chain::field_def                        , (name)(type) )
FC_REFLECT( ultrainio::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( ultrainio::chain::action_def                       , (name)(type)(ricardian_contract)(ability) )

...
class wabt_runtime : public ultrainio::chain::wasm_runtime_interface {
   public:
      wabt_runtime();
...
#define _REGISTER_WABT_INTRINSIC(CLS, MOD, METHOD, WASM_SIG, NAME, SIG)\
   static ultrainio::chain::webassembly::wabt_runtime::intrinsic_registrator _INTRINSIC_NAME(__wabt_intrinsic_fn, __COUNTER__) (\
      MOD,\
      NAME,\
      ultrainio::chain::webassembly::wabt_runtime::wabt_function_type_provider<WASM_SIG>::type(),\
      ultrainio::chain::webassembly::wabt_runtime::intrinsic_function_invoker_wrapper<SIG>::type::fn<&CLS::METHOD>()\
   );\

} } } }// ultrainio::chain::webassembly::wabt_runtime

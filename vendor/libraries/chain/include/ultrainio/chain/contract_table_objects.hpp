...
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::table_id_object, ultrainio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::key_value_object, ultrainio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::index64_object, ultrainio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::index128_object, ultrainio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::index256_object, ultrainio::chain::index256_index)

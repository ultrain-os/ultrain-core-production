...
namespace ultrainio
{
   namespace chain 
   {
	...
	uint32_t chain::config::default_max_block_net_usage = 1024*1024*2;
	uint32_t chain::config::default_max_transaction_net_usage = chain::config::default_max_block_net_usage/2;
   }
}

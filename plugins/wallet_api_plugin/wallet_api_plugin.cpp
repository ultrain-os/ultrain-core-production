 ...
 */
#include <ultrainio/wallet_api_plugin/wallet_api_plugin.hpp>
...
FC_REFLECT(ultrainio::detail::wallet_api_plugin_empty, );
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     ultrainio::detail::wallet_api_plugin_empty result;
...
void wallet_api_plugin::plugin_startup() {
   ...
   app().get_plugin<http_plugin>().add_api({
       CALL(wallet_mgr, wallet_mgr, set_timeout,

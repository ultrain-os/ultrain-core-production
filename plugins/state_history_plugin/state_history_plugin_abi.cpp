extern const char* const state_history_plugin_abi = R"({
    ...
    "structs": [
        ...
        {
            "name": "packed_generated_transaction", "fields": [
                { "name": "packed_trx", "type": "bytes" }
            ]
        },
        {
        ...
        },
        {
            "name": "signed_block_header", "base": "block_header", "fields": [
                { "name": "producer_signature", "type": "string" }
            ]
        },
        {
        ...
        {
            "name": "name_vec", "fields": [
                { "type": "name", "name": "name_v" }
            ]
        },
        {
        ...
        },
        {
            "name": "permission_link_v0", "fields": [
                ...
                { "type": "name", "name": "code" },
                { "type": "name_ex", "name": "message_type" },
    ...
    "variants": [
        ...
        { "name": "transaction_variant", "types": ["transaction_id", "packed_transaction", "packed_generated_transaction"] },

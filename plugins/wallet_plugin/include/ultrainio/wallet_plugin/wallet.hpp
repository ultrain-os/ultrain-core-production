...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key ULTRAIN6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( ultrainio::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( ultrainio::wallet::plain_keys, (checksum)(keys) )

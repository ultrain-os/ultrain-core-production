...
CHAINBASE_SET_INDEX_TYPE( ultrainio::account_control_history_object, ultrainio::account_control_history_multi_index )

FC_REFLECT( ultrainio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )

...
CHAINBASE_SET_INDEX_TYPE( ultrainio::public_key_history_object, ultrainio::public_key_history_multi_index )

FC_REFLECT( ultrainio::public_key_history_object, (public_key)(name)(permission) )

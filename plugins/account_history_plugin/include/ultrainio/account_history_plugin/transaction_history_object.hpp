...
CHAINBASE_SET_INDEX_TYPE( ultrainio::transaction_history_object, ultrainio::transaction_history_multi_index )

FC_REFLECT( ultrainio::transaction_history_object, (block_id)(transaction_id)(transaction_status) )

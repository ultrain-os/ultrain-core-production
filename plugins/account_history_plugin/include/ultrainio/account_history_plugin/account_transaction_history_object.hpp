...
namespace std {
   ...
   template<>
   struct hash<ultrainio::chain::account_name>
   {
    size_t operator()( const ultrainio::chain::account_name& name )const
    {
...
CHAINBASE_SET_INDEX_TYPE( ultrainio::account_transaction_history_object, ultrainio::account_transaction_history_multi_index )

FC_REFLECT( ultrainio::account_transaction_history_object, (name)(transaction_id) )

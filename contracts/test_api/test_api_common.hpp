...
#ifdef DISABLE_ULTRAINLIB_SERIALIZE
#include <ultrainiolib/serialize.hpp>
#undef ULTRAINLIB_SERIALIZE
#define ULTRAINLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  ULTRAINLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   ULTRAINLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   ULTRAINLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   ULTRAINLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};

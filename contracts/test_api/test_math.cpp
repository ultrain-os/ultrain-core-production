...
void test_math::test_multeq() {
  ...
  ultrainio_assert( n == sizeof(u128_action), "test_multeq n == sizeof(u128_action)" );

  uint128_t self  = *(act.values);
  uint128_t other = *(act.values+1);
  ultrainio::multeq(self, other);
  ultrainio_assert( self == act.values[2], "test_multeq act.values[0] == act.values[2]" );
}

void test_math::test_diveq() {
  u128_action act;
  auto n = read_action_data(&act, sizeof(u128_action));
  ultrainio_assert( n == sizeof(u128_action), "test_diveq n == sizeof(u128_action)" );

  uint128_t self  = *(act.values);
  uint128_t other = *(act.values+1);

  ultrainio::diveq(self, other);
  ultrainio_assert( self == act.values[2], "test_diveq act.values[0] == act.values[2]" );
}
...
void test_math::test_i64_to_double()
{
   ...
   ultrainio_assert(i[0] == d, "test_i64_to_double i[0] == d");

   d = i64_to_double(uint64_t(-2));
   ultrainio_assert(i[1] == d, "test_i64_to_double i[1] == d");

   d = i64_to_double(100000);
   ultrainio_assert(i[2] == d, "test_i64_to_double i[2] == d");

   d = i64_to_double(uint64_t(-100000));
   ultrainio_assert(i[3] == d, "test_i64_to_double i[3] == d");

   d = i64_to_double(0);
   ultrainio_assert(0 == d, "test_i64_to_double 0 == d");
}
...
void test_math::test_double_to_i64()
{
   ...
   ultrainio_assert(2 == i, "test_double_to_i64 2 == i");

   i = (int64_t)double_to_i64(d[1]);
   ultrainio_assert(-2 == i, "test_double_to_i64 -2 == i");

   i = (int64_t)double_to_i64(d[2]);
   ultrainio_assert(100000 == i, "test_double_to_i64 100000 == i");

   i = (int64_t)double_to_i64(d[3]);
   ultrainio_assert(-100000 == i, "test_double_to_i64 -100000 == i");

   i = (int64_t)double_to_i64(0);
   ultrainio_assert(0 == i, "test_double_to_i64 0 == i");
}
...
void test_math::test_double_api() {
  ...
  ultrainio_assert( double_to_i64(res) == 1, "double funcs");
  ...
  ultrainio_assert(res == 1, "double_eq");
  ...
  ultrainio_assert(res == 1, "double_gt");
  ...
  ultrainio_assert(res == 1, "double_lt");
}

 ...
 * @details ULTRAINIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief ULTRAINIO Signature
 * @details ULTRAINIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of ULTRAINIO Transaction Id
 * @details Type of ULTRAINIO Transaction Id. It is 256-bit hash
 */

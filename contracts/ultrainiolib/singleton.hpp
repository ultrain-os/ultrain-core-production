...
namespace  ultrainio {
    ...
    *  @brief Defines ULTRAINIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         ULTRAINLIB_SERIALIZE( row, (value) )
      };

      typedef ultrainio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            ultrainio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }

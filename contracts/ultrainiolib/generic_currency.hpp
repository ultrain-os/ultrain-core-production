   ...
   class generic_currency {
      public:
          ...
          ACTION( code, issue ) {
             ...
             ULTRAINLIB_SERIALIZE( issue, (to)(quantity) )
          };
          ...
          ACTION( code, transfer ) {
             ...
             friend DataStream& operator >> ( DataStream& ds, transfer& t ){
                ...
                ultrainio_assert( t.quantity.symbol== token_type::symbol, "unexpected asset type" );
                return ds;
             }
          };
          ...
          struct transfer_memo : public transfer {
             ...
             ULTRAINLIB_SERIALIZE_DERIVED( transfer_memo, transfer, (memo) )
          };
          ...
          struct account {
             ...
             ULTRAINLIB_SERIALIZE( account, (balance)(symbol) )
          };
          ...
          struct currency_stats {
             ...
             ULTRAINLIB_SERIALIZE( currency_stats, (supply)(symbol) )
          };
           ...
           */
          typedef ultrainio::multi_index<accounts_table_name, account> accounts;
          typedef ultrainio::multi_index<stats_table_name, currency_stats> stats;
         ...
         static void apply( account_name c, action_name act) {
            ultrainio::dispatch<generic_currency, transfer, issue>(c,act);
         }
   };

   ...
   class currency {
      public:
         ...
         struct create {
           ...
           // array<char,32>         issuer_agreement_hash;
            ...
            ULTRAINLIB_SERIALIZE( create, (issuer)(maximum_supply)(issuer_can_freeze)(issuer_can_recall)(issuer_can_whitelist) )
         };
         ...
         struct transfer
         {
            ...
            ULTRAINLIB_SERIALIZE( transfer, (from)(to)(quantity)(memo) )
         };
         ...
         struct issue {
            ...
            ULTRAINLIB_SERIALIZE( issue, (to)(quantity)(memo) )
         };
         ...
         struct fee_schedule {
            ...
            ULTRAINLIB_SERIALIZE( fee_schedule, (fee_per_length) )
         };
         ...
         struct account {
            ...
            ULTRAINLIB_SERIALIZE( account, (balance)(frozen)(whitelist) )
         };
         ...
         struct currency_stats {
            ...
            ULTRAINLIB_SERIALIZE( currency_stats, (supply)(max_supply)(issuer)(can_freeze)(can_recall)(can_whitelist)(is_frozen)(enforce_whitelist) )
         };
      ...
      private:
          void sub_balance( account_name owner, asset value, const currency_stats& st ) {
             ...
             if( has_auth( owner ) ) {
                ultrainio_assert( !st.can_freeze || !from.frozen, "account is frozen by issuer" );
                ultrainio_assert( !st.can_freeze || !st.is_frozen, "all transfers are frozen by issuer" );
                ultrainio_assert( !st.enforce_whitelist || from.whitelist, "account is not white listed" );
             } else if( has_auth( st.issuer ) ) {
                ultrainio_assert( st.can_recall, "issuer may not recall token" );
             } else {

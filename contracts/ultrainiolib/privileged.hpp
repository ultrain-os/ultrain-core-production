...
namespace ultrainio {
   ...
   struct blockchain_parameters {
      ...
      ULTRAINLIB_SERIALIZE( blockchain_parameters,
   ...
   struct producer_key {
      ...
      ULTRAINLIB_SERIALIZE( producer_key, (producer_name)(block_signing_key) )
   };
   ...
   struct producer_schedule {
      ...
      ULTRAINLIB_SERIALIZE( producer_schedule, (version)(producers) )
   };

   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { ultrainio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { ultrainio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            ultrainio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return ultrainio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline ultrainio::datastream<Stream>& operator>> (ultrainio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline ultrainio::datastream<Stream>& operator<< (ultrainio::datastream<Stream>& ds, const optional& op)
         {

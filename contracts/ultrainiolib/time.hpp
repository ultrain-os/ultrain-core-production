...
namespace ultrainio {
  class microseconds {
    public:
        ...
        int64_t _count;
        ULTRAINLIB_SERIALIZE( microseconds, (_count) )
    private:
  ...
  class time_point {
    public:
        ...
        ULTRAINLIB_SERIALIZE( time_point, (elapsed) )
  };
  ...
  class time_point_sec
  {
    public:
        ...
        operator time_point()const { return time_point( ultrainio::seconds( utc_seconds) ); }
        uint32_t sec_since_epoch()const { return utc_seconds; }

        time_point_sec operator = ( const ultrainio::time_point& t )
        {
          utc_seconds = uint32_t(t.time_since_epoch().count() / 1000000ll);
          return *this;
        }
        ...
        ULTRAINLIB_SERIALIZE( time_point_sec, (utc_seconds) )
  };

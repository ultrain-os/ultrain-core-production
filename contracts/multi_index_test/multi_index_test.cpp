...
struct limit_order {
   ...
   account_name owner;
      ...
      ULTRAINLIB_SERIALIZE( limit_order, (id)(price)(expiration)(owner) )
   };
   ...
   struct test_k256 {
      ...
      ULTRAINLIB_SERIALIZE( test_k256, (id)(val) )
   };
   ...
   class multi_index_test {
      public:
         ...
         ACTION(N(multitest), trigger) {
            ...
            ULTRAINLIB_SERIALIZE(trigger, (what))
         };
         ...
         static void on(const trigger& act)
         {
            ...
            switch(act.what)
            {
               case 0:
               {
                  ...
                  ultrainio::multi_index<N(orders), limit_order,
               ...
               case 1: // Test key265 secondary index
               {
                  ...
                  ultrainio::multi_index<N(test1), test_k256,
               ...
               break;
               default:
                  ultrainio_assert(0, "Given what code is not supported.");
               break;
            }
         }
   };
...
namespace multi_index_test {
   extern "C" {
      ...
      void apply( uint64_t receiver, uint64_t code, uint64_t action ) {
         require_auth(code);
         ultrainio_assert(ultrainio::dispatch<multi_index_test, multi_index_test::trigger>(code, action),
                      "Could not dispatch");
      }
   }
}

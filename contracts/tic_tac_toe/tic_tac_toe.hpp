...
namespace tic_tac_toe {
   ...
   struct game {
      ...
      ULTRAINLIB_SERIALIZE( game, (challenger)(host)(turn)(winner)(board) )
   };
   ...
   struct create {
      ...
      ULTRAINLIB_SERIALIZE( create, (challenger)(host) )
   };
   ...
   struct restart {
      ...
      ULTRAINLIB_SERIALIZE( restart, (challenger)(host)(by) )
   };
   ...
   struct close {
      ...
      ULTRAINLIB_SERIALIZE( close, (challenger)(host) )
   };
   ...
   struct movement {
      ...
      ULTRAINLIB_SERIALIZE( movement, (row)(column) )
   };
   ...
   struct move {
      ...
      ULTRAINLIB_SERIALIZE( move, (challenger)(host)(by)(mvt) )
   };

   /**
    * @brief table definition, used to store existing games and their current state
    */
   typedef ultrainio::multi_index< games_account, game> games;
}
/// @}

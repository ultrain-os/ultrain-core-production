...
#include <ultrainiolib/vector.hpp>

namespace identity {
   using ultrainio::action_meta;
   ...
   class contract {
      public:
         ...
         struct create : public action_meta< code, N(create) >
         {
            ...
            ULTRAINLIB_SERIALIZE( create, (creator)(identity) )
         };
         ...
         struct certvalue {
            ...
            ULTRAINLIB_SERIALIZE( certvalue, (property)(type)(data)(memo)(confidence) )
         };
         ...
         struct certprop : public action_meta< code, N(certprop) >
         {
            ...
            ULTRAINLIB_SERIALIZE( certprop, (bill_storage_to)(certifier)(identity)(values) )
         };
         ...
         struct settrust : public action_meta< code, N(settrust) >
         {
            ...
            ULTRAINLIB_SERIALIZE( settrust, (trustor)(trusting)(trust) )
         };
         ...
         struct certrow {
            ...
            ULTRAINLIB_SERIALIZE( certrow , (property)(trusted)(certifier)(confidence)(type)(data)(id) )
         };
         ...
         struct identrow {
            ...
            ULTRAINLIB_SERIALIZE( identrow , (identity)(creator) )
         };
         ...
         struct trustrow {
            ...
            ULTRAINLIB_SERIALIZE( trustrow, (account) )
         };

         typedef ultrainio::multi_index<N(certs), certrow,
                                    ultrainio::indexed_by< N(bytuple), ultrainio::const_mem_fun<certrow, key256, &certrow::get_key> >
                                    > certs_table;
         typedef ultrainio::multi_index<N(ident), identrow> idents_table;
         typedef singleton<code, N(account), code, identity_name>  accounts_table;
         typedef ultrainio::multi_index<N(trust), trustrow> trust_table;
         ...
         static void on( const create& c ) {
            ...
            ultrainio_assert( c.identity != 0, "identity=0 is not allowed" );
         ...
         static void on( const certprop& cert ) {
            ...
            idents_table t( code, code );
            ultrainio_assert( t.find( cert.identity ) != t.end(), "identity does not exist" );
            ...
            for( const auto& value : cert.values ) {
               auto idx = certs.template get_index<N(bytuple)>();
               if (value.confidence) {
                  ultrainio_assert(value.type.size() <= 32, "certrow::type should be not longer than 32 bytes");
         ...
         static void apply( account_name c, action_name act) {
            ultrainio::dispatch<contract, create, certprop, settrust>(c,act);
         }

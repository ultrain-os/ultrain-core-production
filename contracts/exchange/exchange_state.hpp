...
namespace ultrainio {
   ...
   struct margin_state {
      ...
      extended_asset unlend( double ishares ) {
         ...
         ultrainio_assert( interest_shares >= 0, "underflow" );
         ultrainio_assert( total_lendable.amount >= 0, "underflow" );

         return result;
      }

      ULTRAINLIB_SERIALIZE( margin_state, (total_lendable)(total_lent)(least_collateralized)(interest_shares) )
   };
   ...
   struct exchange_state {
      ...
      struct connector {
         ...
         ULTRAINLIB_SERIALIZE( connector, (balance)(weight)(peer_margin) )
      };
      ...
      ULTRAINLIB_SERIALIZE( exchange_state, (manager)(supply)(fee)(base)(quote) )
   };

   typedef ultrainio::multi_index<N(markets), exchange_state> markets;

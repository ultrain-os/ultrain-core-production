...
walletMgr=testUtils.WalletMgr(True, nodultrainPort=DEFAULT_PORT-100)
testSuccessful=False
killEosInstances=not dontKill
killWallet=not dontKill

WalletdName="ultrain-walletd"
ClientName="ultrainc"
...
try:
    ...
    # TODO need to update ultrainio.system contract to use new currency and update clultrain and chain_plugin for interaction
...
# TODO Currently unable to set producer
    ...
    # approve producer
    # INFO="$(programs/clultrain/clultrain --host $SERVER --port $PORT --wallet-port 8899 set producer inita testera approve)"
    # verifyErrorCode "clultrain approve producer"
    ...
    # unapprove producer
    # INFO="$(programs/clultrain/clultrain --host $SERVER --port $PORT --wallet-port 8899 set producer inita testera unapprove)"
    # verifyErrorCode "clultrain unapprove producer"

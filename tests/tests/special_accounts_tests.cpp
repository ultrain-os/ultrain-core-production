...
using tester = ultrainio::testing::tester;
...
{ try {
      ...
      auto expected_threshold = ULTRAIN_PERCENT_CEIL(gpo.active_producers.producers.size(), config::producers_authority_threshold_pct);

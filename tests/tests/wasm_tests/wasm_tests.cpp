...
{ try {
      ...
      {
         ultrainio::chain::signed_transaction txn;
         txn.scope = {"currency"};
         txn.messages.resize(1);
         txn.messages[0].code = config::ultrain_contract_name;
      ...
      ultrainio::chain::signed_transaction txn2;
...
{ try {
   ...
   ultrainio::chain::signed_transaction txn3;
   ...
   ultrainio::chain::signed_transaction txn4;
   ...
   ultrainio::chain::signed_transaction txn11;
   ...
   ultrainio::chain::signed_transaction txn12;
   ...
   ultrainio::chain::signed_transaction txn13;
   ...
   ultrainio::chain::signed_transaction txn14;
   ...
   ultrainio::chain::signed_transaction txn15;
   ...
   ultrainio::chain::signed_transaction txn21;
   ...
   ultrainio::chain::signed_transaction txn22;
   ...
   ultrainio::chain::signed_transaction txn23;
   ...
   ultrainio::chain::signed_transaction txn24;
   ...
   ultrainio::chain::signed_transaction txn25;

...
#include <ultrainio/chain/contracts/chain_initializer.hpp>
...
auto get_resolver(const contracts::abi_def& abi = contracts::abi_def())
{
   return [&abi](const account_name &name) -> optional<contracts::abi_serializer> {
      return abi_serializer(chain_initializer::ultrain_contract_abi(abi));
   };
}
...
{ try {
   ...
   abi_serializer abis(chain_initializer::ultrain_contract_abi(abi));
   abis.validate();
...
using namespace ultrainio::tests::config;

struct abi_gen_helper {

  abi_gen_helper() {}

  static bool is_abi_generation_exception(const ultrainio::abi_generation_exception& e) { return true; };

  bool generate_abi(const char* source, const char* abi, bool opt_sfs=false) {

    std::string include_param = std::string("-I") + ultrainiolib_path;
    std::string pfr_include_param = std::string("-I") + pfr_include_path;
    std::string boost_include_param = std::string("-I") + boost_include_path;
    std::string stdcpp_include_param = std::string("-I") + ultrainiolib_path + "/libc++/upstream/include";
    std::string stdc_include_param = std::string("-I") + ultrainiolib_path +  "/musl/upstream/include";
    ...
    bool res = runToolOnCodeWithArgs(new find_ultrainio_abi_macro_action(contract, actions, ""), source,
    ...
    abi_serializer(chain_initializer::ultrain_contract_abi(output)).validate();
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unknown_type, ""), ultrainio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(double_base, ""), ultrainio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unable_to_determine_index, ""), ultrainio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_type_different_namespace, ""), ultrainio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(bad_index_type, "{}"), ultrainio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(union_table, ""), ultrainio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_action_different_type, ""), ultrainio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
} FC_LOG_AND_RETHROW() }
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(abigen_vector_multidimension, ""), ultrainio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
BOOST_FIXTURE_TEST_CASE(abgigen_ultrainioabi_macro, abi_gen_helper)
{ try {

   const char* abgigen_ultrainioabi_macro = R"=====(
      ...
      struct hello : public ultrainio::contract {
        public:
   ...
   const char* abgigen_ultrainioabi_macro_abi = R"=====(
   {
     "types": [],
     "structs": [{
         "name": "hi",
   ...
   BOOST_TEST( generate_abi(abgigen_ultrainioabi_macro, abgigen_ultrainioabi_macro_abi) == true );
...
{ try {
   ...
   const char* abgigen_contract_inheritance = R"=====(
      ...
      ULTRAINIO_ABI(new_hello,(hi)(bye))
...
{ try {
   ...
   auto abi = chain_initializer::ultrain_contract_abi(fc::json::from_string(my_abi).as<abi_def>());
   ...
   const char *my_other = R"=====(
    {
      "publickey"     :  "UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
      "publickey_arr" :  ["UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV"],
      "asset"         : "100.0000 UTR",
      "asset_arr"     : ["100.0000 UTR","100.0000 UTR"],

      "string"            : "ola ke ase",
      "string_arr"        : ["ola ke ase","ola ke desi"],
      "time"              : "2021-12-20T15:30",
      "time_arr"          : ["2021-12-20T15:30","2021-12-20T15:31"],
      "signature"         : "UTRJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U",
      "signature_arr"     : ["UTRJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U","UTRJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U"],
      ...
      "strx": {
        ...
        "expiration":"2021-12-20T15:30",
        "region": "1",
        "signatures" : ["UTRJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U"],
      ...
      "keyweight": {"key":"UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},
      "keyweight_arr": [{"key":"UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},{"key":"UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":100},{"key":"UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":200}],
...
{ try {
   ...
   auto abi = chain_initializer::ultrain_contract_abi(fc::json::from_string(typedef_cycle_abi).as<abi_def>());
   abi_serializer abis(abi);
...
{ try {
   ...
   abi_serializer abis(chain_initializer::ultrain_contract_abi(abi_def()));
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "data" : {
        ...
        "keys" : [ {"key" : "UTR65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", "weight" : 57005},
                   {"key" : "UTR5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", "weight" : 57605} ],
   ...
   BOOST_TEST("UTR65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)updateauth.data.keys[0].key);
   BOOST_TEST(57005u == updateauth.data.keys[0].weight);
   BOOST_TEST("UTR5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)updateauth.data.keys[1].key);
...
{ try {
   ...
   BOOST_TEST("UTR65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newaccount.owner.keys[0].key);
   BOOST_TEST(57005u == newaccount.owner.keys[0].weight);
   BOOST_TEST("UTR5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newaccount.owner.keys[1].key);
   ...
   BOOST_TEST("UTR65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newaccount.active.keys[0].key);
   BOOST_TEST(57005u == newaccount.active.keys[0].weight);
   BOOST_TEST("UTR5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newaccount.active.keys[1].key);
   ...
   BOOST_TEST("UTR65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newaccount.recovery.keys[0].key);
   BOOST_TEST(57005u == newaccount.recovery.keys[0].weight);
   BOOST_TEST("UTR5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newaccount.recovery.keys[1].key);
...
{ try {
   ...
   BOOST_TEST("UTR65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)postrecovery.data.keys[0].key);
...
{ try {
   ...
   auto abi = chain_initializer::ultrain_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());

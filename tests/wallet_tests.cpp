...
{ try {
   using namespace ultrainio::wallet;
...
{ try {
   ...
   constexpr auto key3 = "5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3"; // ultrainio key
   ...
   // ultrainio key is imported automatically when a wallet is created

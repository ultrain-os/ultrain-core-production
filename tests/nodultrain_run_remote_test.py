...
###############################################################
# nodultrain_run_remote_test
#  Tests remote capability of the nodultrain_run_test. Test will setup cluster and pass nodes info to nodultrain_run_test. E.g.
#  nodultrain_run_remote_test.py -v --clean-run --dump-error-detail
###############################################################
...
pnodes=1
total_nodes=pnodes
actualTest="tests/nodultrain_run_test.py"
...
try:
    ...
    Print("Starting up %s test: %s" % ("nodultrain", actualTest))
    Print("cmd: %s\n" % (cmd))

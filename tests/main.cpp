...
//extern uint32_t ULTRAIN_TESTING_GENESIS_TIMESTAMP;
...
boost::unit_test::test_suite* init_unit_test_suite(int argc, char* argv[]) {
   ...
   /*
   const char* genesis_timestamp_str = getenv("ULTRAIN_TESTING_GENESIS_TIMESTAMP");
   if( genesis_timestamp_str != nullptr )
   {
      ULTRAIN_TESTING_GENESIS_TIMESTAMP = std::stoul( genesis_timestamp_str );
   }
   std::cout << "ULTRAIN_TESTING_GENESIS_TIMESTAMP is " << ULTRAIN_TESTING_GENESIS_TIMESTAMP << std::endl;
   */
   return nullptr;
}

...
launcherPath="programs/ultrainio-launcher/ultrainio-launcher"
clientPath="programs/clultrain/clultrain"

rm -rf etc/ultrainio/node_* var/lib/* stage
ls -l etc/ultrainio var/lib

debugArg=""
if [ "$debug" == true ]; then
   debugArg="--nodultrain \"--log-level-net-plugin debug\""
fi
...
while [ $count -lt $total_nodes ]; do
    ...
    echo =================================================================
    echo Contents of etc/ultrainio/node_${num}/config.ini:
    cat etc/ultrainio/node_${num}/config.ini
    echo =================================================================

...
namespace ultrainio { namespace test {
...
#define EXPECT_3(P, E, T) ultrainio::test::expect<P>(E,T,"EXPECT<" #P ">(" #E "," #T ")")
#define EXPECT_2(E, T) ultrainio::test::expect(E,T,"EXPECT(" #E "," #T ")")
#define EXPECT_1(E) ultrainio::test::expect(E,"EXPECT(" #E ")")

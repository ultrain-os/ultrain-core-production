...
# --kill-count <nodultrain instances to kill>
...
try:
    ...
    wallet=walletMgr.create(walletName, [cluster.ultrainioAccount,cluster.defproduceraAccount,cluster.defproducerbAccount])
    if wallet is None:
    ...
    Print("nodultrain instances killed.")
    ...
    Print("nodultrain instances relaunched.")

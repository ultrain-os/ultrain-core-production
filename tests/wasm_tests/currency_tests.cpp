...
BOOST_FIXTURE_TEST_CASE(test_symbol, TESTER) try {
   ...
   {
      symbol ultrain(4, "UTR");
      BOOST_REQUIRE_EQUAL(ULTRAIN_SYMBOL_VALUE, ultrain.value());
      BOOST_REQUIRE_EQUAL("4,UTR", ultrain.to_string());
      BOOST_REQUIRE_EQUAL("UTR", ultrain.name());
      BOOST_REQUIRE_EQUAL(4, ultrain.decimals());
   }
   ...
   // default is "4,UTR"
   {
      ...
      BOOST_REQUIRE_EQUAL("UTR", def.name());
   }
   // from string
   {

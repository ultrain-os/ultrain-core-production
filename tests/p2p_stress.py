...
class StressNetwork:
    ...
    def execute(self, cmdInd, node, ta, ultrainio):
        ...
        tr = node.createAccount(ta, ultrainio, stakedDeposit=0, waitForTransBlock=True)
        ...
        contract="ultrainio"
        action="issue"
        data="{\"to\":\"" + acc1.name + "\",\"quantity\":\"1000000.0000 ULTRAIN\"}"

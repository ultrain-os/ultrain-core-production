...
const char* error_advice_3030011 =  "You can try embedding ultrainio nonce action inside your transaction to ensure uniqueness.";
...
const char* error_advice_3120002 = R"=====(Public key should be encoded in base58 and starts with UTR prefix)=====";
...
{
  "threshold":"1",
  "keys":[{ "key":"UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"1" }],
  "accounts":[{
...
e.g.
{
  "signatures" : [ "UTRJze4m1ZHQ4UjuHpBcX6uHPN4Xyggv52raQMTBZJghzDLepaPcSGCNYTxaP2NiaF4yRF5RaYwqsQYAwBwFtfuTJr34Z5GJX" ],
  "compression" : "none",
...
const char* error_advice_3130001 =  "Ensure that you have \033[2multrainio::chain_api_plugin\033[0m\033[32m added to your node's configuration!";
const char* error_advice_3130002 =  "Ensure that you have \033[2multrainio::wallet_api_plugin\033[0m\033[32m added to your node's configuration!\n"\
...
const char* error_advice_3130003 =  "Ensure that you have \033[2multrainio::account_history_api_plugin\033[0m\033[32m added to your node's configuration!";
const char* error_advice_3130004 =  "Ensure that you have \033[2multrainio::net_api_plugin\033[0m\033[32m added to your node's configuration!";
...
bool print_recognized_errors(const fc::exception& e, const bool verbose_errors) {
   // ultrain recognized error code is from 3000000 to 3999999

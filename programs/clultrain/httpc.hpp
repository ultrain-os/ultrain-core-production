...
namespace ultrainio { namespace client { namespace http {
   ...
   const string get_account_exist = chain_func_base + "/get_account_exist";
   const string get_trans_fee = chain_func_base + "/get_trans_fee";
   ...
   const string get_resource_orders_func = chain_func_base + "/get_resource_orders";

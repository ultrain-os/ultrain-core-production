...
namespace ultrainio { namespace client { namespace http {
...
#elif defined( _WIN32 )
         ULTRAIN_THROW(http_exception, "HTTPS on Windows not supported");
#else
   ...
   if( status_code == 200 || status_code == 201 || status_code == 202 ) {
      ...
      auto &&error_info = response_result.as<ultrainio::error_results>().error;
   ...
   ULTRAIN_ASSERT( status_code == 200, http_request_fail, "Error code ${c}\n: ${msg}\n", ("c", status_code)("msg", re) );
   return response_result;
   }
}}}

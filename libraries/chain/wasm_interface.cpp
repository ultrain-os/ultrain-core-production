...
class privileged_api : public context_aware_api {
   public:
      ...
      void set_active_producers( array_ptr<char> packed_producer_schedule, size_t datalen) {
         ...
         ULTRAIN_ASSERT(psch.producers.size() == unique_producers.size(), wasm_execution_error, "duplicate producer name in producer schedule");
...
class system_api : public context_aware_api {
   public:
      ...
      void ultrainio_assert(bool condition, null_terminated_ptr str) {
         if( !condition ) {

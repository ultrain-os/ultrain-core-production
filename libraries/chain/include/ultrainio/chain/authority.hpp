...
FC_REFLECT(ultrainio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(ultrainio::chain::key_weight, (key)(weight) )
FC_REFLECT(ultrainio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(ultrainio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(ultrainio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )

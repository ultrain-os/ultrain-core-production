...
FC_REFLECT(ultrainio::chain::permission_object, (id)(owner)(parent)(name)(auth)(last_updated)(delay))

FC_REFLECT(chainbase::oid<ultrainio::chain::permission_usage_object>, (_id))
FC_REFLECT(ultrainio::chain::permission_usage_object, (id)(account)(permission)(last_used))

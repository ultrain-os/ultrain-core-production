...
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::action_permission_object, ultrainio::chain::action_permission_index)

FC_REFLECT(ultrainio::chain::action_permission_object, (id)(owner)(owner_permission)(scope_permission) )

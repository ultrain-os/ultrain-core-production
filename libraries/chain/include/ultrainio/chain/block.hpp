...
FC_REFLECT(ultrainio::chain::block_header, (previous)(timestamp)
           (transaction_mroot)(action_mroot)(block_mroot)
           (producer)(schedule_version)(new_producers))

FC_REFLECT_DERIVED(ultrainio::chain::signed_block_header, (ultrainio::chain::block_header), (producer_signature))
FC_REFLECT( ultrainio::chain::shard_lock, (account)(scope))
FC_REFLECT( ultrainio::chain::shard_summary, (read_locks)(write_locks)(transactions))
FC_REFLECT( ultrainio::chain::region_summary, (region)(cycles_summary) )
FC_REFLECT_DERIVED(ultrainio::chain::signed_block_summary, (ultrainio::chain::signed_block_header), (regions))
FC_REFLECT_DERIVED(ultrainio::chain::signed_block, (ultrainio::chain::signed_block_summary), (input_transactions))

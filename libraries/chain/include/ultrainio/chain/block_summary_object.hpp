...
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::block_summary_object, ultrainio::chain::block_summary_multi_index)

FC_REFLECT( ultrainio::chain::block_summary_object, (block_id) )

...
#include <ultrainio/chain/immutable_chain_parameters.hpp>
...
struct genesis_state_type {
   ...
   public_key_type                          initial_key = fc::variant("UTR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV").as<public_key_type>();
...
FC_REFLECT(ultrainio::chain::contracts::genesis_state_type,

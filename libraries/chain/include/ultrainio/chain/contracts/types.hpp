...
FC_REFLECT( ultrainio::chain::contracts::type_def                         , (new_type_name)(type) )
FC_REFLECT( ultrainio::chain::contracts::field_def                        , (name)(type) )
FC_REFLECT( ultrainio::chain::contracts::struct_def                       , (name)(base)(fields) )
FC_REFLECT( ultrainio::chain::contracts::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( ultrainio::chain::contracts::clause_pair                      , (id)(body) )
FC_REFLECT( ultrainio::chain::contracts::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( ultrainio::chain::contracts::abi_def                          , (types)(structs)(actions)(tables)(clauses) )

FC_REFLECT( ultrainio::chain::contracts::newaccount                       , (creator)(name)(owner)(active)(recovery) )
FC_REFLECT( ultrainio::chain::contracts::setcode                          , (account)(vmtype)(vmversion)(code) ) //abi
FC_REFLECT( ultrainio::chain::contracts::setabi                           , (account)(abi) )
FC_REFLECT( ultrainio::chain::contracts::updateauth                       , (account)(permission)(parent)(data)(delay) )
FC_REFLECT( ultrainio::chain::contracts::deleteauth                       , (account)(permission) )
FC_REFLECT( ultrainio::chain::contracts::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( ultrainio::chain::contracts::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( ultrainio::chain::contracts::postrecovery                     , (account)(data)(memo) )
FC_REFLECT( ultrainio::chain::contracts::passrecovery                     , (account) )
FC_REFLECT( ultrainio::chain::contracts::vetorecovery                     , (account) )
FC_REFLECT( ultrainio::chain::contracts::canceldelay                      , (trx_id) )

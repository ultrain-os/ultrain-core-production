...
#include <ultrainio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::contracts::table_id_object, ultrainio::chain::contracts::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::contracts::key_value_object, ultrainio::chain::contracts::key_value_index)

CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::contracts::index64_object, ultrainio::chain::contracts::index64_index)
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::contracts::index128_object, ultrainio::chain::contracts::index128_index)
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::contracts::index256_object, ultrainio::chain::contracts::index256_index)
CHAINBASE_SET_INDEX_TYPE(ultrainio::chain::contracts::index_double_object, ultrainio::chain::contracts::index_double_index)

FC_REFLECT(ultrainio::chain::contracts::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(ultrainio::chain::contracts::key_value_object, (id)(t_id)(primary_key)(value)(payer) )

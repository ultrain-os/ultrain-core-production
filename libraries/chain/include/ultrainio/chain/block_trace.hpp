...
FC_REFLECT( ultrainio::chain::shard_trace, (shard_action_root)(shard_transaction_root)(transaction_traces)(cpu_usage)(read_locks)(write_locks))
FC_REFLECT( ultrainio::chain::cycle_trace, (shard_traces))
FC_REFLECT( ultrainio::chain::region_trace, (cycle_traces))
FC_REFLECT( ultrainio::chain::block_trace, (region_traces))
